  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0 text-dark">Menu Riwayat</h3>
          </div><!-- /.col -->
          <!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-yellow">
              <div class="inner">
                ...
                <p>Melihat Daftar Kegiatan yang masih dalam proses</p>
              </div>
              <div class="icon">
                <i class="nav-icon fas fa-table"></i>
              </div>
              <a href="riwayat-belum.php" class="small-box-footer">Pergi... <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-green">
              <div class="inner">
                ...
                <p>Melihat Daftar Kegiatan Yang Sudah selesai di SPM kan</p>
              </div>
              <div class="icon">
                <i class="nav-icon fas fa-car"></i>
              </div>
              <a href="riwayat-sudah.php" class="small-box-footer">Pergi... <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
