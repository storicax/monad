          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Rekap Pagu Anggaran Bidang <?=$bidang?></h3><br/>


               <a href="download-detail-bidang.php?bidang=<?=$bidang?>"> <button type="button" class="btn btn-success">download</button></a>
