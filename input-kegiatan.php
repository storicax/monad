  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0 text-dark">Input Kegiatan</h3>
          </div><!-- /.col -->
          <!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-lime">
              <div class="inner">
                ...
                <p>Input Kegiatan yang diajukan dari bidang</p>
              </div>
              <div class="icon">
                <i class="nav-icon fas fa-table"></i>
              </div>
              <a href="input-item.php" class="small-box-footer">Pergi... <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-orange">
              <div class="inner">
                ...
                <p>Merubah status kegiatan untuk di SPM kan</p>
              </div>
              <div class="icon">
                <i class="nav-icon fas fa-car"></i>
              </div>
              <a href="rubah-status.php" class="small-box-footer">Pergi... <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
